...
function titlHtml(startTime, endTime) {
	...
	if (startTime != null && endTime != null) {
		timeHtml = "从  <a><strong>" + startTime + "</strong></a>到  <a><strong>" + endTime + "</strong></a>间 的舆情统计报表";
	} else {
		timeHtml = "从  <a><strong>" + params.startTime + "</strong></a>到  <a><strong>" + params.endTime
		+ "</strong></a>间 的舆情统计报表";
	}
...
function OutlineDisplay() {
	...
	$.post(url,{"recentDays" : recentDays},function(data) {
		if (data.data != null && data.data.statData != null) {
			...
			OutlineHtml = 
				...
				+ "个</li></ul>"
				+ "<ul class='read23'><li>监测预警舆情&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='epoquery.html?warn=-6&recentDays=1'><strong>"
				+ resultData.warningCount
				+ "</strong></a>条</li>"
				+ "<li>初判负面舆情&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='epoquery.html?sentiment=-1&recentDays=1'><strong>"
				+ resultData.negCount
				+ "</strong></a>条</li>"
				+ "<li>监测舆情数量&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='epoquery.html?recentDays=1'><strong>"
				+ resultData.totalCount
				+ "</strong></a>条</li></ul>"
				+ "<ul class='read33'><li>重点关注舆情&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='epoquery.html?attentionLevel=3&recentDays=1'><strong>"
				+ resultData.attSpecialCount
				+ "</strong></a>条</li>"
				+ "<li>比较关注舆情&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='epoquery.html?attentionLevel=2&recentDays=1'><strong>"
				+ resultData.attComparCount
				+ "</strong></a>条</li>"
				+ "<li>一般关注舆情&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='epoquery.html?attentionLevel=1&recentDays=1'><strong>"
				+ resultData.attGeneralCount + "</strong></a>条</li></ul>";
		} else
			OutlineHtml = "没有相关数据";
...
function loadColumn() {
	...
	$.post(url,{"type" : 1},function(data) {
		if (data.data != null && data.data.topicData != null) {
			...
			$.each(topicData,function(entrtIndex, entry) {
				if (entry.topicCat != null) {
					...
					if (entry.topicList != null) {
						...
						opinionInfoHtml += "<div class='accordion-body collapse' id='accordion-element-2"
							+ i + "'>";
						$.each(entry.topicList,function(subEntrtIndex, subEntry) {
...
function paperDisplayById(obj) {
	...
	var OutlineHtml = "";
	var url = '../../handler/epostat/statSum';
	$.post(url,{"recentDays" : 1},function(data) {
		if (data.data != null && data.data.statData != null) {
			var resultData = data.data.statData;
